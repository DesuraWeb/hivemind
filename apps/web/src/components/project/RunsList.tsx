 ...
 * dépliables, diffs, screenshots). Aucune route ne rend aujourd'hui les
 * messages d'un run : la ligne resterait cliquable pour n'ouvrir que du vide.
 * Les lignes sont donc informatives et non cliquables tant que la piste
 * d'audit n'est pas exposée.
 *
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 8, maxWidth: 900 }}>
      ...
      <span style={{ font: '11px var(--font-mono)', color: 'var(--text-low)', padding: '6px 2px' }}>
        piste d&rsquo;audit détaillée d&rsquo;un run · pas encore exposée par l&rsquo;API
      </span>
    </div>
  )
}
